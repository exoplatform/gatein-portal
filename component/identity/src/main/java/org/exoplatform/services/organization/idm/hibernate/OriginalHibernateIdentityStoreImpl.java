 ...
 * with some modifications for some modifiers of methods
 * 
 */
public class OriginalHibernateIdentityStoreImpl implements IdentityStore, Serializable {
  ...
  public OriginalHibernateIdentityStoreImpl(String id)
  {
     this.id = id;
  }
  ...
  protected void checkIOType(IdentityObjectType iot) throws IdentityException
  {
     if (iot == null)
     {
  ...
  protected HibernateIdentityObjectType getHibernateIdentityObjectType(IdentityStoreInvocationContext ctx, IdentityObjectType type) throws IdentityException
  {
  ...
  protected HibernateRealm getRealm(Session hibernateSession, IdentityStoreInvocationContext ctx) throws IdentityException
  {
   ...
   * @return
   */
  protected String resolveAttributeStoreMapping(IdentityObjectType type, String name) throws IdentityException
  {
     String mapping = null;
  ...
  protected void applyQueryParameters(Query hibernateQuery, Map<String, Object> queryParams)
  {
